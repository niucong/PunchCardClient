package com.niucong.punchcardclient.util;
...
public class CalendarReminderUtils {
    ...
    private static String CALENDARS_ACCOUNT_NAME = "test@buct.com";
    private static String CALENDARS_ACCOUNT_TYPE = "com.android.test";
    private static String CALENDARS_DISPLAY_NAME = "账户";
     ...
     * @param start        开始时间
     * @param end          结束时间
     * @param previousTime 提前提醒时间（分钟）
     */
    public static void addCalendarEvent(Context context, String title, String description, long start, long end, long previousTime) {
        if (context == null) {
            return;
        }
        ...
        values.put(CalendarContract.Reminders.MINUTES, previousTime);
